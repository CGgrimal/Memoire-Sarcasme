...
# Replace output layer for French classification
def modify_output_layer(model, num_classes):
    x = model.layers[-2].output  # Take the output from the second last layer
...
def main():
    ...
    max_len = 300  # Example max_len, should match with English dataset model
