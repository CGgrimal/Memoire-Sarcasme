...
def main():
    ...
    filename = sys.argv[1]
    vectors_name = sys.argv[2]  # This should point to a .kv, .bin, or .txt file containing word vectors
    ...
    # Adjust binary parameter based on the format of your word vectors
    word_vectors = KeyedVectors.load(vectors_name)  # Use binary=False for .txt files
