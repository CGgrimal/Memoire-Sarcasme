...
def retrain_top_layers(model):
    ...
    """
    # Unlock the top layers (for fine-tuning the top layers)
    for layer in model.layers:
        layer.trainable = True  # Retrain all layers in this case
...
def main():
    ...
    num_classes = 1  # Adjust for binary or multi-class classification
